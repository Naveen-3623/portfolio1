...
const Footer = () => {
  ...
  const socialLinks = [
    { href: "https://www.linkedin.com/in/naveen-kumar-s-23035429a/", label: "LinkedIn" },
    { href: "https://github.com/Naveen-3623", label: "GitHub" },
  ];
    ...
    <footer className="bg-background border-t border-border relative overflow-hidden">
      ...
      <div className="relative w-full overflow-hidden py-16 md:py-24">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="heading-display text-[clamp(2.25rem,10vw,8rem)] leading-[0.9] text-center whitespace-normal text-balance px-4"
        >
          <span className="text-foreground">LET’S BUILD TOGETHER</span>
        </motion.h2>
      </div>
        ...
        <div className="container mx-auto">
            ...
            >
              ...
              <div className="space-y-4">
                <a 
                  ...
                  className="text-foreground hover:text-primary transition-colors text-lg font-medium story-link inline-block break-all"
                >
          ...
          >
            <p className="text-sm text-muted-foreground">
              © {currentYear} Naveen Kumar S. All rights reserved.
            </p>
            <p className="text-sm text-muted-foreground">
              <span className="text-primary">Full-stack developer</span> who ships.
            </p>
          </motion.div>
        </div>
      </div>
